...
//         detail::get_storage_option<typename in_mds_t::layout_type,
//         static_rows,
//                                    static_cols>();
...
//     using matrix_t = Eigen::Matrix<typename in_mds_t::value_type,
//     static_rows,
//                                    static_cols, option>;
...
//     return Eigen::Map<mapped_matrix_t,
//     Eigen::Unaligned>{in_mds.data_handle(),
//                                                          rows, cols};
// }
