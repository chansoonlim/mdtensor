...
TEST(run_time, 1) {
    ...
    EXPECT_TRUE(md::array_equal(
        out, md::tensor<value_t, md::extents<index_t, 5>>{{1, 1, 1, 1, 1}}));
}
...
TEST(run_time, 3) {
    ...
    EXPECT_TRUE(md::array_equal(
        out, md::tensor<value_t, md::extents<index_t, 2, 1>>{{1, 1}}));
}
...
TEST(run_time, 4) {
    ...
    EXPECT_TRUE(md::array_equal(
        out, md::tensor<value_t, md::extents<index_t, 2, 2>>{{1, 1, 1, 1}}));
}
