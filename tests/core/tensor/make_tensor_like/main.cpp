...
TEST(make_tensor_like, 1) {
    using value_t = int;
    using index_t = std::size_t;

    constexpr auto a1 =
        md::core::tensor<value_t, md::core::extents<index_t, 2, 2>>{};
    constexpr auto a1_like = md::core::make_tensor_like(a1);
    ...
    constexpr auto a2 =
        md::core::tensor<value_t, md::core::extents<index_t, 2, 2>>{
            {1, 2, 3, 4}};
    constexpr auto a2_like = md::core::make_tensor_like(a2);
    ...
    const auto b1_like = md::core::make_tensor_like(b1);
    ...
    const auto b2_like = md::core::make_tensor_like(b2);
    ...
    constexpr auto c_like = md::core::make_tensor_like(c);
